...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public static final double kTurningEncoderPositionFactor = 0.2932153046;
    ...
    public static final SparkBaseConfig.IdleMode kDrivingMotorIdleMode = IdleMode.kBrake;
    public static final SparkBaseConfig.IdleMode kTurningMotorIdleMode = IdleMode.kBrake;
