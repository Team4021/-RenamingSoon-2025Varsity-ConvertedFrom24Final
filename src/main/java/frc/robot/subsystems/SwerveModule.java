...
public class SwerveModule {
  ...
  private final SparkMaxConfig m_sparkMaxDrivingConfig;
  private final SparkMaxConfig m_sparkMaxTurningConfig;
  ...
  public SwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset, int turningCANcoderId, double cancoderOffset) {
    ...
    m_sparkMaxDrivingConfig = new SparkMaxConfig();
    m_sparkMaxTurningConfig = new SparkMaxConfig();

    // setup driving config
    m_sparkMaxDrivingConfig
      .inverted(true)
    ...
    m_sparkMaxDrivingConfig.encoder
     ...
     m_sparkMaxDrivingConfig.closedLoop
    ...
    // setup turning config      
    m_sparkMaxTurningConfig
      .inverted(true)
    ...
    // native units for position and velocity are rotations and RPM, respectively,
    // but we want meters and meters per second to use with WPILib's swerve APIs.
    m_sparkMaxTurningConfig.encoder
    ...
    m_sparkMaxTurningConfig.closedLoop
      .feedbackSensor(FeedbackSensor.kPrimaryEncoder)
      .positionWrappingEnabled(true)
      .positionWrappingMinInput(/*ModuleConstants.kTurningEncoderPositionPIDMinInput*/-Math.PI * (150 / 7))
      .positionWrappingMaxInput(/*ModuleConstants.kTurningEncoderPositionPIDMaxInput*/Math.PI * (150 / 7))
    ...
    m_drivingSparkMax.configure(m_sparkMaxDrivingConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    m_turningSparkMax.configure(m_sparkMaxTurningConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    //m_drivingSparkMax.configAccessor.closedLoop.
  ...
  public void resetToAbsolutePosition() {
    ...
    m_turningSparkMax.getEncoder().setPosition(angle);
  }
